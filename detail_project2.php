                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="s_product_text">
                        ...
                        <ul class="list">
                            ...
                            <li><a href="detail_project3.php"><span>Status</span> : <b
                                        id="status_projek_menunggu">Menunggu Persetujuan Operator</b></a></li>
                        ...
                        <div class="card_area d-flex align-items-center">
                            <!-- <a class="primary-btn" href="#" data-toggle="modal" data-target="#myModal">AJUKAN</a> -->
