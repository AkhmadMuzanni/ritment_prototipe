        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light main_box round">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="beranda.php"><img src="img/logo_ritment.png" alt="" style="height: 50px;"></a>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item"><a class="nav-link" href="beranda.php">RISEEK</a></li>
